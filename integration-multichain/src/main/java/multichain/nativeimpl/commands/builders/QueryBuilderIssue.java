...
public class QueryBuilderIssue extends QueryBuilderCommon {
	 ...
	 *
	 */
	protected  String executeGetAssetBalances(String chain) throws MultichainException {
		return execute(chain, CommandEnum.GETASSETBALANCES);
	}
	 ...
	 * @throws MultichainException
	 */
	protected  String executeIssue(String chain, String address, String assetName, int quantity, float unit)
			throws MultichainException {
		...
		return execute(chain, CommandEnum.ISSUE, formatJson(address), formatJson(assetName), formatJson(quantity),
				formatJson(unit));
	}
	 ...
	 * @throws MultichainException
	 */
	protected  String executeIssue(String chain, String address, List<AssetParams> assets, int quantity,
		...
		return execute(chain, CommandEnum.ISSUE, formatJson(address), formatJson(assets), formatJson(quantity),
				formatJson(unit));
	}
	 ...
	 * @throws MultichainException
	 */
	protected  String executeIssueFrom(String chain, String fromAddress, String toAddress, String assetName,
		...
		return execute(chain, CommandEnum.ISSUE, formatJson(toAddress), formatJson(assetName), formatJson(quantity),
				formatJson(unit));
	}
	 ...
	 * @throws MultichainException
	 */
	protected  String executeIssueFrom(String chain, String fromAddress, String toAddress,
			List<AssetParams> assets, int quantity, float unit) throws MultichainException {
		MultichainTestParameter.isNotNullOrEmpty("toAddress", toAddress);
		MultichainTestParameter.isNotNullOrEmpty("fromAddress", fromAddress);
		...
		return execute(chain, CommandEnum.ISSUE, formatJson(toAddress), formatJson(assets), formatJson(quantity),
				formatJson(unit));
	}
	 ...
	 * @throws MultichainException
	 */
	protected  String executeIssueMore(String chain, String address, String assetName, int quantity)
			throws MultichainException {
		MultichainTestParameter.isNotNullOrEmpty("address", address);
		MultichainTestParameter.isNotNullOrEmpty("assetName", assetName);
		MultichainTestParameter.valueIsPositive("quantity", quantity);
		return execute(chain, CommandEnum.ISSUEMORE, formatJson(address), formatJson(assetName), formatJson(quantity));
	}
	 ...
	 * @throws MultichainException
	 */
	protected  String executeIssueMoreFrom(String chain, String fromAddress, String toAddress, String assetName,
			int quantity) throws MultichainException {
		MultichainTestParameter.isNotNullOrEmpty("toAddress", toAddress);
		MultichainTestParameter.isNotNullOrEmpty("fromAddress", fromAddress);
		MultichainTestParameter.isNotNullOrEmpty("assetName", assetName);
		MultichainTestParameter.valueIsPositive("quantity", quantity);
		return execute(chain, CommandEnum.ISSUEMOREFROM, formatJson(fromAddress), formatJson(toAddress),
	 ...
	 * @throws MultichainException
	 */
	protected  String executeListAssets(String chain, String asset, boolean verbose) throws MultichainException {
		MultichainTestParameter.isNotNullOrEmpty("asset", asset);
		return execute(chain, CommandEnum.LISTASSETS, formatJson(asset), formatJson(verbose));
	}
	 ...
	 * @throws MultichainException
	 */
	protected  String executeSendAssetFrom(String chain, String fromAddress, String toAddress, String assetName,
			float quantity) throws MultichainException {
		MultichainTestParameter.isNotNullOrEmpty("fromAddress", fromAddress);
		MultichainTestParameter.isNotNullOrEmpty("toAddress", toAddress);
		MultichainTestParameter.isNotNullOrEmpty("assetName", assetName);
		MultichainTestParameter.valueIsPositive("quantity", quantity);
		return execute(chain, CommandEnum.SENDASSETFROM, formatJson(fromAddress), formatJson(toAddress),
				formatJson(assetName), formatJson(quantity));
	}
	 ...
	 * @throws MultichainException
	 */
	protected  String executeSendAssetToAddress(String chain, String address, String assetName, float quantity)
			throws MultichainException {
		MultichainTestParameter.isNotNullOrEmpty("address", address);
		MultichainTestParameter.isNotNullOrEmpty("assetName", assetName);
		MultichainTestParameter.valueIsPositive("quantity", quantity);
		return execute(chain, CommandEnum.SENDASSETTOADDRESS, formatJson(address), formatJson(assetName),
				formatJson(quantity));
	}
