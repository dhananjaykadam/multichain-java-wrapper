...
public class QueryBuilderGrant extends QueryBuilderCommon {
	...
	private String formatPermissionsList(int permissions) {
	 ...
	 */
	protected String executeGrant(String chain, String address, int permissions) throws MultichainException {
		...
		return execute(chain, CommandEnum.GRANT, formatJson(address), formatJson(permissionsFormated));
	}
	 ...
	 * @throws MultichainException
	 */
	protected String executeGrantFrom(String chain, String addressFrom, String address, int permissions)
			throws MultichainException {
		String permissionsFormated = formatPermissionsList(permissions);
		...
		return execute(chain, CommandEnum.GRANTFROM, formatJson(addressFrom), formatJson(address),
	 ...
	 * @throws MultichainException
	 */
	protected String executeListPermissions(String chain, int permissions, String address, boolean verbose)
			throws MultichainException {
		String permissionsFormated = formatPermissionsList(permissions);
		...
		if (permissionsFormated == null || "".equals(permissionsFormated)) {
			listPermissions = execute(chain, CommandEnum.LISTPERMISSIONS, "all");
		} else if (address == null || "".equals(address)) {
			listPermissions = execute(chain, CommandEnum.LISTPERMISSIONS, "all", formatJson(permissionsFormated));
		} else {
			listPermissions = execute(chain, CommandEnum.LISTPERMISSIONS, "all", formatJson(permissionsFormated),
	 ...
	 * @throws MultichainException
	 */
	protected String executeRevoke(String chain, String address, int permissions) throws MultichainException {
		String permissionsFormated = formatPermissionsList(permissions);

		MultichainTestParameter.isNotNullOrEmpty("address", address);
		MultichainTestParameter.isNotNullOrEmpty("permissionsFormated", permissionsFormated);

		return execute(chain, CommandEnum.REVOKE, formatJson(address), formatJson(permissionsFormated));
	}
	 ...
	 * @throws MultichainException
	 */
	protected String executeRevokeFrom(String chain, String addressFrom, String address, int permissions)
			throws MultichainException {
		String permissionsFormated = formatPermissionsList(permissions);
		...
		return execute(chain, CommandEnum.REVOKE, formatJson(addressFrom), formatJson(address),
				formatJson(permissionsFormated));
	}
}
