...
public class QueryBuilderWalletTransaction extends QueryBuilderCommon {
	 ...
	 */
	protected String executeGetAddressTransaction(String chain, String address, String txid, boolean verbose)
			throws MultichainException {
		MultichainTestParameter.isNotNullOrEmpty("address", address);
		MultichainTestParameter.isNotNullOrEmpty("txid", txid);
		return execute(chain, CommandEnum.GETADDRESSTRANSACTION, formatJson(address), formatJson(txid),
				formatJson(verbose));
	}
	 ...
	 * @throws MultichainException
	 */
	protected String executeGetTransaction(String chain, String txid, boolean includeWatchonly)
			throws MultichainException {
		MultichainTestParameter.isNotNullOrEmpty("txid", txid);
		return execute(chain, CommandEnum.GETTRANSACTION, formatJson(txid), formatJson(includeWatchonly));
	}
	 ...
	 * @throws MultichainException
	 */
	protected String executeGetTxOut(String chain, String txid, int vout, boolean includemempool)
			throws MultichainException {
		MultichainTestParameter.isNotNullOrEmpty("txid", txid);
		MultichainTestParameter.valueIsPositive("vout", vout);
		return execute(chain, CommandEnum.GETTXOUT, formatJson(txid), formatJson(vout), formatJson(includemempool));
	}
	 ...
	 * @throws MultichainException
	 */
	protected String executeGetWalletTransaction(String chain, String txid, boolean includeWatchOnly, boolean verbose)
			throws MultichainException {
		return execute(chain, CommandEnum.GETWALLETTRANSACTION, formatJson(txid), formatJson(includeWatchOnly),
				formatJson(verbose));
	 ...
	 * @throws MultichainException
	 */
	protected String executeListAddressTransactions(String chain, String address, long count, long skip,
		...
		return execute(chain, CommandEnum.LISTADDRESSTRANSACTIONS, formatJson(address), formatJson(count),
				formatJson(skip), formatJson(verbose));
	}
	 ...
	 * @throws MultichainException
	 */
	protected String executeListWalletTransaction(String chain, long count, long skip, boolean includeWatchonly,
			boolean verbose) throws MultichainException {
		MultichainTestParameter.valueIsPositive("count", count);
		MultichainTestParameter.valueIsPositive("skip", skip);
		return execute(chain, CommandEnum.LISTWALLETTRANSACTIONS, formatJson(count), formatJson(skip),
	 ...
	 * @throws MultichainException
	 */
	protected String executeSendFromAddress(String chain, String fromAddress, String toAddress,
		...
		return execute(chain, CommandEnum.SENDFROMADDRESS, formatJson(fromAddress), formatJson(toAddress),
				formatJson(assets));
	}
	 ...
	 * @throws MultichainException
	 */
	protected String executeSendFromAddress(String chain, String fromAddress, String toAddress, double amount)
			throws MultichainException {
		MultichainTestParameter.isNotNullOrEmpty("fromAddress", fromAddress);
		MultichainTestParameter.isNotNullOrEmpty("toAddress", toAddress);
		MultichainTestParameter.valueIsPositive("amount", amount);

		return execute(chain, CommandEnum.SENDFROMADDRESS, fromAddress, toAddress, formatJson(amount));
	}
	 ...
	 * @throws MultichainException
	 */
	protected String executeSendToAddress(String chain, String address, List<BalanceAssetBase> assets)
			throws MultichainException {
		MultichainTestParameter.isNotNullOrEmpty("address", address);
		if (assets == null || assets.isEmpty()) {
			throw new MultichainException("assets", "assets needed to be sent");
		...
		return execute(chain, CommandEnum.SENDTOADDRESS, formatJson(address), formatJson(assets));
	}
	 ...
	 * @throws MultichainException
	 */
	protected String executeSendToAddress(String chain, String address, double amount) throws MultichainException {
		MultichainTestParameter.isNotNullOrEmpty("address", address);
		MultichainTestParameter.valueIsPositive("amount", amount);

		return execute(chain, CommandEnum.SENDTOADDRESS, formatJson(address), formatJson(amount));
	}
	 ...
	 * @throws MultichainException
	 */
	protected String executeSendWithMetaData(String chain, String address, List<BalanceAssetBase> assets,
		...
		return execute(chain, CommandEnum.SENDWITHMETADATA, formatJson(address), formatJson(assets),
				formatJson(hexMetaData));
	}
	 ...
	 * @throws MultichainException
	 */
	protected String executeSendWithMetaData(String chain, String address, double amount, String hexMetaData)
			throws MultichainException {
		MultichainTestParameter.isNotNullOrEmpty("address", address);
		MultichainTestParameter.isNotNullOrEmpty("hexMetaData", hexMetaData);
		MultichainTestParameter.valueIsPositive("amount", amount);

		return execute(chain, CommandEnum.SENDWITHMETADATA, formatJson(address), formatJson(amount),
				formatJson(hexMetaData));
	}
	 ...
	 * @throws MultichainException
	 */
	protected String executeSendWithMetaDataFrom(String chain, String fromAddress, String toAddress,
		...
		return execute(chain, CommandEnum.SENDWITHMETADATAFROM, formatJson(fromAddress), formatJson(toAddress),
	 ...
	 * @throws MultichainException
	 */
	protected String executeSendWithMetaDataFrom(String chain, String fromAddress, String toAddress, double amount,
			String hexMetaData) throws MultichainException {
		MultichainTestParameter.isNotNullOrEmpty("fromAddress", fromAddress);
		MultichainTestParameter.isNotNullOrEmpty("toAddress", toAddress);
		MultichainTestParameter.isNotNullOrEmpty("hexMetaData", hexMetaData);
