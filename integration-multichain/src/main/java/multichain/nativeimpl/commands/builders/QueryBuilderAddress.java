...
public class QueryBuilderAddress extends QueryBuilderCommon {
	 ...
	 */
	protected String executeAddMultiSigAddress(String chain, int numberOfSigRequired, String[] publicKeys)
			throws MultichainException {
		...
		if (publicKeys.length >= numberOfSigRequired) {
			return execute(chain, CommandEnum.ADDMULTISIGADDRESS, formatJson(numberOfSigRequired),
					formatJson(publicKeys));
		} else {
	 ...
	 * @throws MultichainException
	 */
	protected String executeCreateMultiSig(String chain, int numberOfSigRequired, String[] publicKeys)
			throws MultichainException {
		...
		if (publicKeys.length >= numberOfSigRequired) {
			return execute(chain, CommandEnum.CREATEMULTISIG, formatJson(numberOfSigRequired), formatJson(publicKeys));
		} else {
			throw new MultichainException("number of signature", "is greater than the size of public keys");
		}
	}
	 ...
	 * @throws MultichainException
	 */
	protected String executeGetAddressBalances(String chain, String address) throws MultichainException {
		MultichainTestParameter.isNotNullOrEmpty("address", address);
		return execute(chain, CommandEnum.GETADDRESSBALANCES, formatJson(address));
	}
	 ...
	 * @throws MultichainException
	 */
	protected String executeGetAddresses(String chain, boolean verbose) throws MultichainException {
		return execute(chain, CommandEnum.GETADDRESSES, String.valueOf(verbose));
	}
	 ...
	 * @return Balances
	 */
	protected String executeGetMultiBalances(String chain, String[] addresses) throws MultichainException {
		return execute(chain, CommandEnum.GETMULTIBALANCES, formatJson(addresses));
	}
	 ...
	 * @throws MultichainException
	 */
	protected String executeGetNewAddress(String chain) throws MultichainException {
		return execute(chain, CommandEnum.GETNEWADDRESS);
	}
	 ...
	 * @throws MultichainException
	 */
	protected String executeImportAddress(String chain, String address, String label, boolean rescan)
			throws MultichainException {
		MultichainTestParameter.isNotNullOrEmpty("address", address);
		return execute(chain, CommandEnum.IMPORTADDRESS, formatJson(address), formatJson(label), formatJson(rescan));
	}
	 ...
	 * @throws MultichainException
	 */
	protected String executeValidateAddress(String chain, String address)
			throws MultichainException, MultichainException {
		MultichainTestParameter.isNotNullOrEmpty("address", address);
		return execute(chain, CommandEnum.VALIDATEADDRESS, formatJson(address));
	}
