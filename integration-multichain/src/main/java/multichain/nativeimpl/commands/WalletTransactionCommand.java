...
import multichain.nativeimpl.commands.builders.QueryBuilderWalletTransaction;
import multichain.nativeimpl.object.BalanceAssetBase;
...
import multichain.nativeimpl.object.formatters.TransactionFormatter;
import multichain.nativeimpl.object.formatters.TxOutFormatter;
import multichain.nativeimpl.object.formatters.WalletTransactionFormatter;
...
public class WalletTransactionCommand extends QueryBuilderWalletTransaction {
	private WalletTransactionFormatter walletTransactionFormatter = new WalletTransactionFormatter();
	private TransactionFormatter transactionFormatter = new TransactionFormatter();
	private TxOutFormatter txOutFormatter = new TxOutFormatter();

	public WalletTransactionCommand(Executor executor) {
	 ...
	 */
	public TransactionWallet getAddressTransaction(String chain, String address, String txid, boolean verbose)
			throws MultichainException {
		String stringGetAddressTransactions = executeGetAddressTransaction(chain, address, txid, verbose);
	 ...
	 * @throws MultichainException
	 */
	public TransactionWallet getAddressTransaction(String chain, String address, String txid)
			throws MultichainException {
		return getAddressTransaction(chain, address, txid, false);
	 ...
	 * @throws MultichainException
	 */
	public Transaction getTransaction(String chain, String txid, boolean includeWatchonly) throws MultichainException {
		String stringTransaction = executeGetTransaction(chain, txid, includeWatchonly);
	 ...
	 * @throws MultichainException
	 */
	public Transaction getTransaction(String chain, String txid) throws MultichainException {
		return getTransaction(chain, txid, false);
	}
	 ...
	 * @throws MultichainException
	 */
	public TxOut getTxOut(String chain, String txid, int vout, boolean includemempool) throws MultichainException {
		String stringTxOut = executeGetTxOut(chain, txid, vout, includemempool);
	 ...
	 * @throws MultichainException
	 */
	public TxOut getTxOut(String chain, String txid, int vout) throws MultichainException {
		return getTxOut(chain, txid, vout, false);
	}
	 ...
	 * @throws MultichainException
	 */
	public TransactionWalletDetailed getWalletTransaction(String chain, String txid, boolean includeWatchOnly,
			boolean verbose) throws MultichainException {
		String stringTransactionWalletDetailed = executeGetWalletTransaction(chain, txid, includeWatchOnly, verbose);
	 ...
	 * @throws MultichainException
	 */
	public TransactionWalletDetailed getWalletTransactionWithDetail(String chain, String txid)
			throws MultichainException {
		return getWalletTransaction(chain, txid, false, true);
	}
	 ...
	 * @throws MultichainException
	 */
	public TransactionWallet getWalletTransactionWithoutDetail(String chain, String txid) throws MultichainException {
		return getWalletTransaction(chain, txid, false, false);
	}
	 ...
	 * @throws MultichainException
	 */
	public List<TransactionWallet> listAddressTransactions(String chain, String address, long count, long skip,
			boolean verbose) throws MultichainException {
		String stringListAddressTransactions = executeListAddressTransactions(chain, address, count, skip, verbose);
	...
	public List<TransactionWallet> listAddressTransactions(String chain, String address, long count, long skip)
			throws MultichainException {
		return listAddressTransactions(chain, address, count, skip, false);
	}
	 ...
	 * @throws MultichainException
	 */
	public List<TransactionWallet> listAddressTransactions(String chain, String address, long count)
			throws MultichainException {
		return listAddressTransactions(chain, address, count, 0, false);
	}
	 ...
	 * @throws MultichainException
	 */
	public List<TransactionWallet> listAddressTransactions(String chain, String address) throws MultichainException {
		return listAddressTransactions(chain, address, 10, 0, false);
	}
	 ...
	 * @throws MultichainException
	 */
	public List<TransactionWallet> listWalletTransaction(String chain, long count, long skip, boolean includeWatchonly,
			boolean verbose) throws MultichainException {
		String stringlistWalletTransaction = executeListWalletTransaction(chain, count, skip, includeWatchonly,
				verbose);
	...
	public List<TransactionWallet> listWalletTransaction(String chain, long count, long skip, boolean includeWatchonly)
			throws MultichainException {
		return listWalletTransaction(chain, count, skip, includeWatchonly, false);
	}
	 ...
	 * @throws MultichainException
	 */
	public List<TransactionWallet> listWalletTransaction(String chain, long count, long skip)
			throws MultichainException {
		return listWalletTransaction(chain, count, skip, false, false);
	}
	 ...
	 * @throws MultichainException
	 */
	public List<TransactionWallet> listWalletTransaction(String chain, long count) throws MultichainException {
		return listWalletTransaction(chain, count, 0, false, false);
	}
	 ...
	 * @throws MultichainException
	 */
	public List<TransactionWallet> listWalletTransaction(String chain) throws MultichainException {
		return listWalletTransaction(chain, 10, 0, false, false);
	}
	 ...
	 * @throws MultichainException
	 */
	public String sendFromAddress(String chain, String fromAddress, String toAddress, List<BalanceAssetBase> assets)
			throws MultichainException {
		return executeSendFromAddress(chain, fromAddress, toAddress, assets);
	}
	 ...
	 * @throws MultichainException
	 */
	public String sendToAddress(String chain, String address, List<BalanceAssetBase> assets)
			throws MultichainException {
		return executeSendToAddress(chain, address, assets);
	}
	 ...
	 * @throws MultichainException
	 */
	public String SendToAddress(String chain, String address, double amount) throws MultichainException {
		return executeSendToAddress(chain, address, amount);
	}
	 ...
	 * @throws MultichainException
	 */
	public String SendWithMetaData(String chain, String address, List<BalanceAssetBase> assets, String hexMetaData)
			throws MultichainException {
		return executeSendWithMetaData(chain, address, assets, hexMetaData);
	}
	 ...
	 * @throws MultichainException
	 */
	public String SendWithMetaData(String chain, String address, double amount, String hexMetaData)
			throws MultichainException {
		return executeSendWithMetaData(chain, address, amount, hexMetaData);
	}
	 ...
	 * @throws MultichainException
	 */
	public String SendWithMetaDataFrom(String chain, String fromAddress, String toAddress,
			List<BalanceAssetBase> assets, String hexMetaData) throws MultichainException {
		return executeSendWithMetaDataFrom(chain, fromAddress, toAddress, assets, hexMetaData);
	}
	 ...
	 * @throws MultichainException
	 */
	public String SendWithMetaDataFrom(String chain, String fromAddress, String toAddress, double amount,
			String hexMetaData) throws MultichainException {
		return executeSendWithMetaDataFrom(chain, fromAddress, toAddress, amount, hexMetaData);
	}
