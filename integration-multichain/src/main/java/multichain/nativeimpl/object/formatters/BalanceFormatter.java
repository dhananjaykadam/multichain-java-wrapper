...
public class BalanceFormatter {
	public final  List<BalanceAsset> formatBalanceAssets(String stringBalanceAsset) {
	...
	public final  BalanceAsset formatBalanceAsset(String stringBalanceAsset) {
		final Gson gson = new GsonBuilder().create();
	...
	public final  List<MultiBalance> formatMultiBalances(String stringMultiBalance) {
		final Gson gson = new GsonBuilder().create();
